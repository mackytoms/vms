...
<head>
    ...
    <title>Visitor Check-In Kiosk - Pan Asia</title>
    ...
    <style>
        * {
        ...
        .form-control-lg:focus, .form-select-lg:focus {
            border-color: #1e9338;
            box-shadow: 0 0 0 0.2rem rgba(30, 147, 56, 0.25);
        }
        ...
        .btn-next {
            ...
            color: white;
            box-shadow: 0 4px 15px rgba(30, 147, 56, 0.3);
        }

        .btn-next:hover {
            transform: translateY(-2px);
            box-shadow: 0 6px 20px rgba(30, 147, 56, 0.4);
        }
        ...
        .switch-content {
            ...
            gap: 10px;
            padding: 8px 16px;
            background: linear-gradient(135deg, #f39c12a8, #e67e22);
            border-radius: 30px;
        ...
        /* Enhanced Swal styling for switch confirmation */
        .swal-wide {
